...
$booking=Booking::get(['id'=>1,'roomId'=>2,'userUid'=>'admin','userName'=>'Admin','purpose'=>'Sitzung','startsAt'=>'2026-07-13T08:00:00+00:00','endsAt'=>'2026-07-13T09:00:00+00:00']);
if ($booking?->roomId()!==2 || $booking->toArray()['purpose']!=='Sitzung') throw new RuntimeException('Booking-Hydration ist fehlerhaft.');
