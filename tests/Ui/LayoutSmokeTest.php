...
foreach (['data-orgsuite data-suite="ad" data-current-app="adroom"','role="tablist"','id="adr-tab-settings"','aria-controls="adr-settings-view"','id="adr-settings-view"','aria-labelledby="adr-tab-settings"','>Einstellungen</button>','<caption>Raumbuchungen','id="adr-booking-dialog"','step="900"','aria-live="polite"'] as $contract) if(!str_contains($template,$contract)) throw new RuntimeException("UI-Vertrag fehlt: {$contract}");
