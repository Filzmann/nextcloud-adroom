...
foreach (['data-orgsuite data-suite="ad" data-current-app="adroom"','id="adr-calendar-view"','<caption>Raumbuchungen','id="adr-booking-dialog"','name="title"','value="SV"','value="HB"','value="LG"','step="900"','aria-live="polite"',"script('adroom','modules/booking-timeline')"] as $contract) if(!str_contains($template,$contract)) throw new RuntimeException("UI-Vertrag fehlt: {$contract}");
