...
for(const contract of ['class Room extends','class Booking extends','class RoomRepository','class MonthCalendar','class BookingDialog','class RoomSettings','adroom:add-booking','aria-selected','canManageRooms','window.confirm']) if(!sources.includes(contract)) throw new Error(`Frontendvertrag fehlt: ${contract}`);
