(function () {
    ...
    function showView(view){ const active=view==='settings'&&!byId('adr-tab-settings').hidden?'settings':'calendar'; const calendarView=byId('adr-calendar-view'); const settingsView=byId('adr-settings-view'); calendarView.hidden=active!=='calendar'; settingsView.hidden=active!=='settings'; byId('adr-tab-calendar').setAttribute('aria-selected',active==='calendar'?'true':'false'); byId('adr-tab-settings').setAttribute('aria-selected',active==='settings'?'true':'false'); }
    ...
    byId('adr-tab-calendar').addEventListener('click',()=>showView('calendar')); byId('adr-tab-settings').addEventListener('click',()=>showView('settings'));
